      ...
      <div class="popmainheading">Edit Profile</div>
          <div class="popmain1con1">
              <div class="popupformmain1">
                  <div class="btn3 tar"><a data-fancybox data-src="#viewpopup" data-options='{"touch": false, "smallBtn" : false}' href="javascript:;">View Profile</a></div>
                      ...
                      @csrf                      
                          ...
                          <div class="popupformmain1box">
                              <div class="popupformmain1boxcol1">
                                  ...
                                  <input type="text" maxlength="128" name="organization" id="organization" value="{{$user->au_company}}" required>
                              </div>
                              <div class="popupformmain1boxcol2">
                                  <label>Job Title</label>
                                  <input type="text" maxlength="128" name="job_title" id="job_title" value="{{$user->au_job_title}}" required>
                              </div>
                          </div>
          ...
          <div class="popmain1con1">
              <div class="popupformmain1">
                  <table class="table2">
                     <tr>
                      <th>View Profile</th>
                      <th><div class="btn1 tar"><a data-fancybox data-src="#editpopup" data-options='{"touch": false, "smallBtn" : false}' href="javascript:;">Edit Profile</a></div></th>
                    </tr>
                    <tr>
                      <td>First Name</td>
                      <td>{{$user->au_fname}}</td>
