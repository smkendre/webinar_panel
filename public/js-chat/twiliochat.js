var twiliochat = (function() {
  ...
  $(document).ready(function() {
    ...
    tc.csrf_token = $("input[name='_token']").val();
  ...
  function fetchAccessToken(username, handler) {
    ...
    $.post('token', {identity: username, device: 'browser', _token: tc.csrf_token }, null, 'json')
...
*/
  ...
  function selectChannel() {
    ...
    // alert("Event: - " + event);
    // console.log(event);
    // alert("Target: - " + Object.values(target));
    // var channelSid = target.data().sid;
    var channelSid = "CH84c7562265624ff692d4e9cf97eb0b62";
    // alert("Channel Sid: - " + channelSid);
    // console.log(channel);
    var selectedChannel = tc.channelArray.filter(function(channel) {
      // alert("channel: - " + Object.values(channel));
    ...
    //   return;
    // }
    // alert("Selected Channel: - " + Object.values(selectedChannel));
